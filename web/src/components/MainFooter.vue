  ...
  <footer class="rc-footer rc-footer-dark">
      ...
      <section class="rc-footer-columns">
        <div class="rc-footer-column">
          ...
          <div class="rc-footer-item">
            ...
            <span class="rc-footer-item-description">
              Ant Design
              of Angular
            </span>
          </div>
          <div class="rc-footer-item">
            <a href="https://ng.mobile.ant.design" target="_blank">NG-ZORRO-MOBILE</a>
          </div>
          <div class="rc-footer-item">
          ...
          <div class="rc-footer-item">
            ...
            <span class="rc-footer-item-separator">-</span>
            <span class="rc-footer-item-description">首页模板集</span>
          </div>
          <div class="rc-footer-item">
            <a href="https://scaffold.ant.design" target="_blank">Scaffolds</a>
            <span class="rc-footer-item-separator">-</span>
            <span class="rc-footer-item-description">脚手架市场</span>
          </div>
          <div class="rc-footer-item">
            <a href="https://umijs.org" target="_blank">Umi</a>
            <span class="rc-footer-item-separator">-</span>
            <span class="rc-footer-item-description">
              React
              应用开发框架
          ...
          <div class="rc-footer-item">
            <a href="https://dvajs.com" target="_blank">Dva</a>
            <span class="rc-footer-item-separator">-</span>
            <span class="rc-footer-item-description">数据流前端框架</span>
          </div>
          <div class="rc-footer-item">
            <a href="https://remaxjs.org/" target="_blank">Remax</a>
            <span class="rc-footer-item-separator">-</span>
            <span class="rc-footer-item-description">全新的小程序开发体验</span>
          </div>
        </div>
        <div class="rc-footer-column">
          <h2>社区</h2>
          <div class="rc-footer-item">
            <a href="https://github.com/websemantics/awesome-ant-design" target="_blank">
              <span class="rc-footer-item-icon">
                <i aria-label="图标: ant-design" class="anticon anticon-ant-design">
                  <svg
              ...
              </span>Awesome Ant Design
            </a>
          </div>
          <div class="rc-footer-item">
            <a href="http://medium.com/ant-design/" target="_blank">
              <span class="rc-footer-item-icon">
                <i aria-label="图标: medium" class="anticon anticon-medium">
                  <svg
                    viewBox="64 64 896 896"
                    focusable="false"
                    class
          ...
          <div class="rc-footer-item">
            <a href="http://twitter.com/antdesignui" target="_blank">
              <span class="rc-footer-item-icon">
                <i
                  aria-label="图标: twitter"
          ...
          <div class="rc-footer-item">
            <a href="http://zhuanlan.zhihu.com/antdesign" target="_blank">
              <span class="rc-footer-item-icon">
                <i
                  aria-label="图标: zhihu"
                  class="anticon anticon-zhihu"
          ...
          <div class="rc-footer-item">
            <a href="http://zhuanlan.zhihu.com/xtech" target="_blank">
              <span class="rc-footer-item-icon">
                <i
                  aria-label="图标: zhihu"
                  class="anticon anticon-zhihu"
          ...
          <div class="rc-footer-item">
            ...
            <span class="rc-footer-item-separator">-</span>
            <span class="rc-footer-item-description">蚂蚁体验科技大会</span>
          </div>
          <div class="rc-footer-item">
            <a href="/docs/spec/work-with-us-cn">
              <span class="rc-footer-item-icon">
        ...
        <div class="rc-footer-column">
          <h2>帮助</h2>
          <div class="rc-footer-item">
            <a href="https://github.com/GOUYONGCHAO/homeworkdone" target="_blank">
              <span class="rc-footer-item-icon">
          ...
          <div class="rc-footer-item">
            <a href="/changelog-cn">
              <span class="rc-footer-item-icon">
                <i aria-label="图标: history" class="anticon anticon-history">
                  <svg
                    viewBox="64 64 896 896"
                    focusable="false"
                    class
          ...
          <div class="rc-footer-item">
            <a href="/docs/react/faq-cn">
              <span class="rc-footer-item-icon">
                <i aria-label="图标: profile" class="anticon anticon-profile">
                  <svg
                    viewBox="64 64 896 896"
                    focusable="false"
                    class
          ...
          <div class="rc-footer-item">
            <a href="https://new-issue.ant.design/" target="_blank">
              <span class="rc-footer-item-icon">
                <i aria-label="图标: bug" class="anticon anticon-bug">
                  <svg
                    viewBox="64 64 896 896"
                    focusable="false"
                    class
          ...
          <div class="rc-footer-item">
            <a href="https://github.com/ant-design/ant-design/issues" target="_blank">
              <span class="rc-footer-item-icon">
                <i aria-label="图标: issues-close" class="anticon anticon-issues-close">
                  <svg
                    viewBox="64 64 896 896"
                    focusable="false"
                    class
                    data-icon="issues-close"
                    width="1em"
                    height="1em"
                    fill="currentColor"
                    aria-hidden="true"
          ...
          <div class="rc-footer-item">
            <a href="https://www.yuque.com/ant-design/course" target="_blank">
              <span class="rc-footer-item-icon">
                <i aria-label="图标: book" class="anticon anticon-book">
                  <svg
                    viewBox="64 64 896 896"
                    focusable="false"
                    class
              ...
              </span>Ant Design 实战教程
            </a>
          </div>
          <div class="rc-footer-item">
            <a href="https://gitter.im/ant-design/ant-design" target="_blank">
              <span class="rc-footer-item-icon">
                <i aria-label="图标: message" class="anticon anticon-message">
                  <svg
                    viewBox="64 64 896 896"
                    focusable="false"
                    class
          ...
          <div class="rc-footer-item">
            <a href="http://stackoverflow.com/questions/tagged/antd" target="_blank">
              <span class="rc-footer-item-icon">
                <i aria-label="图标: question-circle" class="anticon anticon-question-circle">
                  <svg
                    viewBox="64 64 896 896"
                    focusable="false"
                    class
          ...
          <div class="rc-footer-item">
            <a href="https://segmentfault.com/t/antd" target="_blank">
              <span class="rc-footer-item-icon">
                <i aria-label="图标: question-circle" class="anticon anticon-question-circle">
                  <svg
                    viewBox="64 64 896 896"
        ...
        <div class="rc-footer-column">
          ...
          <div class="rc-footer-item">
            <a href="https://yuque.com" target="_blank">
              <span class="rc-footer-item-icon">
                <img
            ...
            <span class="rc-footer-item-separator">-</span>
            <span class="rc-footer-item-description">知识创作与分享工具</span>
          </div>
          <div class="rc-footer-item">
            <a href="https://yunfengdie.com" target="_blank">
              <span class="rc-footer-item-icon">
                <img
            ...
            <span class="rc-footer-item-separator">-</span>
            <span class="rc-footer-item-description">中台建站平台</span>
          </div>
          <div class="rc-footer-item">
            ...
            <span class="rc-footer-item-separator">-</span>
            <span class="rc-footer-item-description">数据可视化</span>
          </div>
          <div class="rc-footer-item">
            ...
            <span class="rc-footer-item-separator">-</span>
            <span class="rc-footer-item-description">企业级 Node 开发框架</span>
          </div>
          <div class="rc-footer-item">
            <a href="https://kitchen.alipay.com" target="_blank">
              <span class="rc-footer-item-icon">
                <img
            ...
            <span class="rc-footer-item-separator">-</span>
            <span class="rc-footer-item-description">Sketch 工具集</span>
          </div>
          <div class="rc-footer-item">
          ...
          <div class="rc-footer-item" style="margin-top: 20px;">
            <a>
              <div>
                <div
                  style="padding: 4px; background-color: rgb(255, 255, 255); border-top-left-radius: 2px; border-top-right-radius: 2px; border-bottom-right-radius: 2px; border-bottom-left-radius: 2px; box-shadow: rgba(0, 0, 0, 0.0980392) 0px 0px 0px 1px; display: inline-block; cursor: pointer; background-position: initial initial; background-repeat: initial initial;"
                >
                  <div
                    style="width: 80px; height: 80px; border-top-left-radius: 2px; border-top-right-radius: 2px; border-bottom-right-radius: 2px; border-bottom-left-radius: 2px; background-color: rgb(24, 144, 255); background-position: initial initial; background-repeat: initial initial;"
                  ></div>
                </div>
              </div>
            </a>
    ...
    <section class="rc-footer-bottom">
      <div class="rc-footer-bottom-container">
        ...
        homeworkdone.net - 作业参考 Copyright&copy; 数智山谷
        <a href="http://www.miit.gov.cn" target="_blank">渝ICP备19014818号-1</a>
      </div>
    </section>
  </footer>
</template>
