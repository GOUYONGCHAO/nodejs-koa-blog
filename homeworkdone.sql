...
-- ----------------------------
--  Table structure for `article`//文章建表语句
-- ----------------------------
DROP TABLE IF EXISTS `article`;
CREATE TABLE `article` (
  `id` int(12) NOT NULL AUTO_INCREMENT  COMMENT 'id',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '标题',
  `author_id` int(12)  COMMENT '作者编号',
  `author` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '作者',
  `special_column_id` int(11)  COMMENT '专栏编号',
  `content` text COLLATE utf8mb4_unicode_ci COMMENT '内容',
  `words` int(6)  DEFAULT '0'  COMMENT '字数',
  `cover` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '封面',
  `category_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT  NULL COMMENT '分类编号',
  `browse` int(20) DEFAULT '0' COMMENT '浏览数量',
  `like` int(10)  DEFAULT '0'  COMMENT '喜欢数量',
  `dislike` int(10)  DEFAULT '0'  COMMENT '不喜欢数量',
  `collections` int(10)  DEFAULT '0'  COMMENT '收藏数',
  `featured` tinyint(1)  DEFAULT '0'  COMMENT '星标文章',
  `reading_time` int(4)  DEFAULT '0'  COMMENT '阅读时间',
